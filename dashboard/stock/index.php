...
<head>
    ...
    <title>Voorraad - kobyskreaties</title>
    <!-- link icon -->
        ...
        <div class="data-overview">
            ...
            <div class="p-5" style="background-image: url(https://console.kobyskreaties.nl/dashboard/images/products/banner2.png); background-size: cover; background-position: center; background-repeat: no-repeat;">
                ...
                <nav class="flex items-center text-gray-400 text-sm my-3">
                    ...
                    <a href="" class="text-white hover:text-gray-300">Voorraad</a>
                </nav>

                <h2 class="text-4xl font-medium text-white">Welkom terug, Jelte Cost 🙌✨</h2>
                <p class="my-4 text-md text-gray-300 w-1/1 lg:w-1/2">
                    Hieronder vind je een overzicht van alle Voorraaden.
                </p>
            </div>

            <!-- Content -->
            <div class="p-3 pt-6">
                <h2 class="text-2xl font-medium textcolor-3">Voorraad</h2>
            </div>
                            ...
                            <tbody>
                                <?php foreach (getStock() as $item) { 
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $item['stock'] ?></td>
                                        <td>
                                            <a href="<?= $main_url ?>dashboard/deliverycosts/edit/?id=<?= $item['id'] ?>" class="text-blue-500 hover:text-blue-700">Bekijken</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
