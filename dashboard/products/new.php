...
<head>
    ...
    <title>Nieuwe Product - kobyskreaties</title>
    <!-- link icon -->
        ...
        <div class="data-overview">
                        ...
                        <div class="p-3 bg-white shadow-md rounded-md card">
                            <div class="grid grid-cols-1 gap-1">
                                <div class="col-span-1 m-2 bg-gray-100 p-3 rounded-md">
                                    ...
                                    <?= createInput('Product naam', 'Product Naam', 'name', 'text', true); ?>
                                    <?= createInputArea('Product beschrijving', 'Product beschrijving', 'description', 'text', true); ?>
                                    ...
                                    <div class="grid grid-cols-2 gap-2">
                                        ...
                                        <!-- HTML for the first select input (Categorie) -->
                                        ...
                                        <!-- HTML for the second select input (Subcategorie) -->
                                        <div class="col-span-1 bg-gray-100 rounded-md">
                                    ...
                                    <div class="grid grid-cols-1 gap-2">
                                        <div class="col-span-1 bg-gray-100 rounded-md">
                                            ...
                                            createSelectInput('Bezorgingskosten', 'Selecteer een bezorgingskost', 'delivery_cost', true, '', $options3, 'Selecteer een bezorgingskost', $values3);
                                            ?>
                                        </div>
            ...
            <script>
                ...
                $('#category').on('change', function() {
                    ...
                    // Send an AJAX request to get the brands by category
                    $.ajax({
                        url: 'getBrandsByCategory.php', // Update this with the appropriate URL
                        type: 'POST',
                        data: {
                            category: selectedValue
                        },
                        success: function(data) {
                            // Update the options for the brand select input
                            $('#brand').html(data);
                        }
                    });
                });
