...
<head>
    ...
    <title>Nieuwe kleur - kobyskreaties</title>
    <!-- link icon -->
...
<body>
    ...
    <body class="">
        ...
        <div class="data-overview">
            ...
            <!-- Content -->
            <form action="<?= $main_url ?>dashboard/colors/save.php" method="post">
                        ...
                        <div class="p-3 bg-white shadow-md rounded-md card">
                            <div class="grid grid-cols-1 gap-1">
                                <div class="col-span-1 m-2 bg-gray-100 p-3 rounded-md">
                                    ...
                                    <?= createInput('Kleur', 'Kleur', 'color', 'text', true);?>
                                </div>
                            </div>
                        </div>
                    </div>
